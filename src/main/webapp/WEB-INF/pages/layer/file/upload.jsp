...
<script type="text/javascript" src="${path}/resources/js/qiniu.js"></script>
<script type="text/javascript" src="${path}/resources/js/file/initUpload.js"></script>
