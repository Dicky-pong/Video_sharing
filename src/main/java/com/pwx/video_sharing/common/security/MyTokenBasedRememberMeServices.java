...
public class MyTokenBasedRememberMeServices extends AbstractRememberMeServices {
        ...
        if (!StringUtils.hasLength(password)) {
            ...
            if (users != null) {
                user = new org.springframework.security.core.userdetails.User(
                    username, users.getPassword(), true, true, true, true,
    ...
    protected UserDetails processAutoLoginCookie(String[] cookieTokens, HttpServletRequest request,
        ...
        Cms_Users users = cmsUserService.findUserByuserName(cookieTokens[0]);
        UserDetails userDetails = null;
        if (users != null) {
            userDetails = new org.springframework.security.core.userdetails.User(
            cookieTokens[0], users.getPassword(), true, true, true, true,
            findUserAuthorities(users));
        }
        request.getSession().setAttribute("CMS_USER_INFO", users);
    ...
    protected void cancelCookies(HttpServletRequest request, HttpServletResponse response){
